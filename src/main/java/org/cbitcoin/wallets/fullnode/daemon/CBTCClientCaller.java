...
public class CBTCClientCaller {
    ...
    public CBTCClientCaller(String installDir)
            throws IOException {
        ...
        if ((zcashcli == null) || (!zcashcli.exists())) {
            throw new IOException(
                    "The Classic Bitcoin Desktop Wallet installation directory (" + installDir + ") needs to contain " +
                            "the command line utilities cbtcd and cbtc-cli. cbtc-cli is missing!");
        }
        ...
        if (zcashd == null || (!zcashd.exists())) {
            throw new IOException(
                    "The Classic Bitcoin command line utility " + zcashcli.getCanonicalPath() +
                            " was found, but cbtcd was not found!");
        }
    }
