...
public class AddressBookPanel extends JPanel {
    ...
    private static final String LOCAL_MENU_SEND_CBTC = Util.local("LOCAL_MENU_SEND_CBTC");
    ...
    private static final String LOCAL_MSG_SEND_CBTC = Util.local("LOCAL_MSG_SEND_CBTC");
    ...
    private JPanel buildButtonsPanel() {
        ...
        sendCashButton = new JButton(LOCAL_MENU_SEND_CBTC);
    ...
    private class AddressMouseListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            JMenuItem sendCash = new JMenuItem(LOCAL_MSG_SEND_CBTC + " " +entry.name);
    ...
    private class AddressListSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            sendCashButton.setText(LOCAL_MSG_SEND_CBTC + " " + name);
