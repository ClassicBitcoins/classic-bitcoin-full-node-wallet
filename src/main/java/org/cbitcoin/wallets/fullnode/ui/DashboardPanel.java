...
import org.cbitcoin.wallets.fullnode.daemon.CBTCClientCaller.NetworkAndBlockchainInfo;
import org.cbitcoin.wallets.fullnode.daemon.CBTCClientCaller.WalletBalance;
import org.cbitcoin.wallets.fullnode.daemon.CBTCClientCaller.WalletCallException;
import org.cbitcoin.wallets.fullnode.daemon.CBTCInstallationObserver;
import org.cbitcoin.wallets.fullnode.daemon.CBTCInstallationObserver.DaemonInfo;
import org.cbitcoin.wallets.fullnode.daemon.DataGatheringThread;
import org.cbitcoin.wallets.fullnode.util.*;
...
public class DashboardPanel
  ...
  private CBTCInstallationObserver installationObserver;
  ...
  private static final String small_icon_resource = "images/cbtc-44.png";

  private static final String LOCAL_MSG_CBTC_WALLET_TITLE = Util.local("LOCAL_MSG_CBTC_WALLET_TITLE");
  private static final String LOCAL_MSG_CBTC_WALLET_TOOLTIP = Util.local("LOCAL_MSG_CBTC_WALLET_TOOLTIP");
  ...
  public DashboardPanel(JFrame parentFrame,
                        CBTCInstallationObserver installationObserver,
                        CBTCClientCaller clientCaller,
    ...
    JLabel cbtcLabel = new JLabel(LOCAL_MSG_CBTC_WALLET_TITLE);
    cbtcLabel.setFont(new Font("Helvetica", Font.BOLD, 28));
    tempPanel.add(cbtcLabel);
    tempPanel.setToolTipText(LOCAL_MSG_CBTC_WALLET_TOOLTIP);
  ...
  private void updateWalletStatusLabel()
    ...
    String text =
        "<html><p text-align: right>" +
            ...
            transparentUCBalance + " CBTC </span><br/> " +
            "<span style=\"" + color2 + "\">" + LOCAL_MSG_Z_BALANCE + ": " +
            privateUCBalance + " CBTC </span><br/> " +
            "<span style=\"" + color3 + "\">" + LOCAL_MSG_TOTAL_BALANCE +
            totalUCBalance + " CBTC </span>"
            + "</p></html>";
    ...
    if ((!transparentBalance.equals(transparentUCBalance)) ||
      ...
      toolTip = "<html>" +
          ...
          LOCAL_MSG_UNCONFIRMED_TOOLTIP_B + ": " + transparentBalance + " CBTC<br/>" +
          LOCAL_MSG_UNCONFIRMED_TOOLTIP_Z + ": <span>" + privateBalance + " CBTC</span><br/>" +
          "Total: <span style=\"font-weight:bold\">" + totalBalance + " CBTC</span>" +
          "</html>";
    }
